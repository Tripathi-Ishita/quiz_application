...
class PythonQuix extends StatefulWidget {
  @override
  _PythonQuixState createState() => _PythonQuixState();
}

class _PythonQuixState extends State<PythonQuix> {
  ...
  Future<void> _loadQuizData() async {
    try {
      // Load the JSON file
      String jsonData = await rootBundle.loadString('assets/questions/python_data.json');
