...
class FlutterQuix extends StatefulWidget {
  @override
  _FlutterQuixState createState() => _FlutterQuixState();
}

class _FlutterQuixState extends State<FlutterQuix> {
  ...
  Future<void> _loadQuizData() async {
    try {
      // Load the JSON file
      String jsonData = await rootBundle.loadString('assets/questions/flutter.json');
