...
class aptiudeQuix extends StatefulWidget {
  @override
  _aptiudeQuixState createState() => _aptiudeQuixState();
}

class _aptiudeQuixState extends State<aptiudeQuix> {
  ...
  Future<void> _loadQuizData() async {
    try {
      // Load the JSON file
      String jsonData = await rootBundle.loadString('assets/questions/apti.json');
  ...
  List<Color> _buttonColors = List.filled(4, Color.fromRGBO(95,101,213,1));
  ...
  void _showNextQuestion() {
    setState(() {
      ...
      if (_currentIndex < 9) {
        ...
        _currentIndex++;
        _buttonColors = List.filled(4, Color.fromRGBO(95,101,213,1),); // Reset button colors for the next question
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromRGBO(95,101,213,1),
                  ...
                  if (_showTimer)
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value: _timer != null ? (_timer!.tick / 60) : 1.0,
